...
**Responsibility:** PDF → Clean text → Chunking → Embeddings → Vector storage
...
**Responsibility:** User query → Embedding → Top-k semantic search
...
Retrieval quality directly determines answer quality. Most RAG failures originate from poor retrieval, not the LLM.
...
**Responsibility:** Context + Question → Grounded answer
